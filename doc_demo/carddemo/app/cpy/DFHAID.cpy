      ...
      * Standard IBM CICS AID key definitions
       01  DFHAID.
         02  DFHENTER   PIC X VALUE QUOTE.
         02  DFHCLEAR   PIC X VALUE '_'.
         02  DFHCLRP    PIC X VALUE X'6D'.
         ...
         02  DFHPF22    PIC X VALUE X'5A'.
         02  DFHPF23    PIC X VALUE X'5B'.
         02  DFHPF24    PIC X VALUE X'5C'.
         02  DFHPEN     PIC X VALUE '='.
         02  DFHOPID    PIC X VALUE 'W'.
         02  DFHMSRE    PIC X VALUE 'X'.
         02  DFHSTRF    PIC X VALUE 'h'.
         02  DFHTRIG    PIC X VALUE X'7F'.
