# BMS File English Documentation: COMEN01.bms

## 1. Executive Summary

`COMEN01.bms` is a BMS source file that defines 1 extracted map(s)/screen(s) across mapset(s) COMEN01. The extracted data links this file to COMEN01C and transaction id(s) CM00. The business-facing title is Main Menu.

## 2. File and Mapset Context

- Source file: `carddemo\app\bms\COMEN01.bms`
- Mapset names: COMEN01
- Associated programs: COMEN01C
- Transaction ids: CM00
- Business name/title: Main Menu
...
- `COMEN1A` / map `COMEN1A`: 28 total field(s), 1 input, 19 output, 8 label, rows 1-24, size (24,80).
...
Repository evidence should be used to confirm the live terminal flow. Linked COBOL programs include COMEN01C.

## 5. Shared Field and Layout Patterns

- Representative labels: Tran:, Date:, Prog:, Time:, Main Menu, Please select an option :, ENTER=Continue  F3=Exit
