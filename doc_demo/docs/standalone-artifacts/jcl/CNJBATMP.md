# JCL English Documentation: CNJBATMP

## 1. Executive Summary

`CNJBATMP` is a standalone batch job defined in `BATCMP.jcl`. The extracted job description is: Compile Batch COBOL Program. It contains 1 execution step(s), reading 0 input dataset reference(s) and writing 0 output dataset reference(s).

## 2. Batch Runtime Context

- Source file: `carddemo\samples\jcl\BATCMP.jcl`
- Job class: `A`
- Message class: `H`
- Application programs/procedures: BUILDBAT
...
This step executes `BUILDBAT` and expands and runs a cataloged procedure. It has 0 DD statement(s).
