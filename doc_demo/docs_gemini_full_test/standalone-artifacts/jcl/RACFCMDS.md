# JCL English Documentation: RACFCMDS

## 1. Executive Summary

`RACFCMDS` is a standalone batch job defined in `RACFCMDS.jcl`. The extracted job description is: No job-card description was extracted.. It contains 1 execution step(s), reading 1 input dataset reference(s) and writing 0 output dataset reference(s).

## 2. Batch Runtime Context

- Source file: `carddemo\samples\jcl\RACFCMDS.jcl`
- Job class: `A`
- Message class: `Y`
...
This step executes `IKJEFT01` and runs TSO/DB2 command processing. It has 3 DD statement(s).
