...
- `CBACT04C` / `ACCOUNT-FILE` / `FD-ACCTFILE-REC`: `FD-ACCTFILE-REC` PIC `-`
- `CBACT04C` / `ACCOUNT-FILE` / `FD-ACCTFILE-REC`: `FD-ACCT-ID` PIC `9(11)`
- `CBACT04C` / `ACCOUNT-FILE` / `FD-ACCTFILE-REC`: `FD-ACCT-DATA` PIC `X(289)`
- `CBTRN01C` / `ACCOUNT-FILE` / `FD-ACCTFILE-REC`: `FD-ACCTFILE-REC` PIC `-`
- `CBTRN01C` / `ACCOUNT-FILE` / `FD-ACCTFILE-REC`: `FD-ACCT-ID` PIC `9(11)`
- `CBTRN01C` / `ACCOUNT-FILE` / `FD-ACCTFILE-REC`: `FD-ACCT-DATA` PIC `X(289)`
- `CBTRN02C` / `ACCOUNT-FILE` / `FD-ACCTFILE-REC`: `FD-ACCTFILE-REC` PIC `-`
- `CBTRN02C` / `ACCOUNT-FILE` / `FD-ACCTFILE-REC`: `FD-ACCT-ID` PIC `9(11)`
- `CBTRN02C` / `ACCOUNT-FILE` / `FD-ACCTFILE-REC`: `FD-ACCT-DATA` PIC `X(289)`
- `CBACT01C` / `ACCTFILE-FILE` / `FD-ACCTFILE-REC`: `FD-ACCTFILE-REC` PIC `-`
