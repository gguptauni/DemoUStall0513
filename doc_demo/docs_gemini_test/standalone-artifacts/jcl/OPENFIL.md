# JCL English Documentation: OPENFIL

## 1. Executive Summary

`OPENFIL` is a standalone batch job defined in `OPENFIL.jcl`. The extracted job description is: Open files in CICS. It contains 1 execution step(s), reading 1 input dataset reference(s) and writing 2 output dataset reference(s).

## 2. Batch Runtime Context

- Source file: `carddemo\app\jcl\OPENFIL.jcl`
- Job class: `A`
- Message class: `0`
