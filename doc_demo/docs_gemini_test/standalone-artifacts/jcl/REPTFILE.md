# JCL English Documentation: REPTFILE

## 1. Executive Summary

`REPTFILE` is a standalone batch job defined in `REPTFILE.jcl`. The extracted job description is: DEF GDG FOR REPORT FILE. It contains 1 execution step(s), reading 1 input dataset reference(s) and writing 0 output dataset reference(s).

## 2. Batch Runtime Context

- Source file: `carddemo\app\jcl\REPTFILE.jcl`
- Job class: `A`
- Message class: `0`
...
- Inline SYSIN: 4 control line(s) are supplied to the step.
